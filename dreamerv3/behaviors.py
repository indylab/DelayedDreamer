...
class GreedyDelayed(nj.Module):
  ...
  def __init__(self, wm, act_space, config):
    ...
    self.ac = agent.ImagDelayedActorCritic(
  ...
  def train(self, imagine_delayed, start, data):
    return self.ac.train(imagine_delayed, start, data)
